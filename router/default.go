...
func Listen(listenIp string) { 
    ...
    v1 := r.Group("/v1")
    {
        ...
        // 得到账户信息
        v1.GET("/customer/account/index",   middleware.PermissionLoginToken, handle.CustomerAccountIndex)
        // 退出登录
        ...
        // #### customer account ####
        // 得到 customer 列表
        v1.GET("/customer/list",                middleware.PermissionLoginToken, middleware.PermissionRole, handle.CustomerList)
        // 增加一个用户
        v1.POST("/customer/addone",             middleware.PermissionLoginToken, handle.CustomerAddOne)
        // 更新一个用户
        v1.PATCH("/customer/updateone",         middleware.PermissionLoginToken, handle.CustomerUpdateById)
        // 更新一个用户
        v1.PATCH("/customer/updatepassword",    middleware.PermissionLoginToken, handle.CustomerUpdatePassword)
        // 删除一个用户
        v1.DELETE("/customer/deleteone",        middleware.PermissionLoginToken, handle.CustomerDeleteById)
        // 批量删除用户
        v1.DELETE("/customer/deletebatch",      middleware.PermissionLoginToken, handle.CustomerDeleteByIds)
        
        // #### customer resource group ####
        // 得到 resource group 列表
        v1.GET("/customer/resourcegroup/list",              middleware.PermissionLoginToken, handle.ResourceGroupList)
        // 增加一个resource group
        v1.POST("/customer/resourcegroup/addone",           middleware.PermissionLoginToken, handle.ResourceGroupAddOne)
        // 更新一个resource group
        v1.PATCH("/customer/resourcegroup/updateone",       middleware.PermissionLoginToken, handle.ResourceGroupUpdateById)
        // 删除一个resource group
        v1.DELETE("/customer/resourcegroup/deleteone",      middleware.PermissionLoginToken, handle.ResourceGroupDeleteById)
        // 批量删除resource group
        v1.DELETE("/customer/resourcegroup/deletebatch",    middleware.PermissionLoginToken, handle.ResourceGroupDeleteByIds)
        
        // #### customer resource ####
        // 得到 resource 列表
        v1.GET("/customer/resource/list",           middleware.PermissionLoginToken, handle.ResourceList)
        // 增加一个resource group
        v1.POST("/customer/resource/addone",        middleware.PermissionLoginToken, handle.ResourceAddOne)
        // 更新一个resource group
        v1.PATCH("/customer/resource/updateone",    middleware.PermissionLoginToken, handle.ResourceUpdateById)
        // 删除一个resource group
        v1.DELETE("/customer/resource/deleteone",   middleware.PermissionLoginToken, handle.ResourceDeleteById)
        // 批量删除resource group
        v1.DELETE("/customer/resource/deletebatch", middleware.PermissionLoginToken, handle.ResourceDeleteByIds)
        
        // #### customer role ####
        // 得到 role 列表
        v1.GET("/customer/role/list",               middleware.PermissionLoginToken, handle.RoleList)
        // 增加一个resource group
        v1.POST("/customer/role/addone",            middleware.PermissionLoginToken, handle.RoleAddOne)
        // 更新一个resource group
        v1.PATCH("/customer/role/updateone",        middleware.PermissionLoginToken, handle.RoleUpdateById)
        // 删除一个resource group
        v1.DELETE("/customer/role/deleteone",       middleware.PermissionLoginToken, handle.RoleDeleteById)
        // 批量删除resource group
        v1.DELETE("/customer/role/deletebatch",     middleware.PermissionLoginToken, handle.RoleDeleteByIds)
