...
func Listen(listenIp string) { 
    ...
    v1 := r.Group("/v1")
    {
        ...
        // #### Whole Category
        v1.GET("/whole/category/list",            middleware.PermissionLoginToken, middleware.CommonAdminChildRole, wholeHandler.CategoryList)
        v1.GET("/whole/category/fetchtrendinfo",  middleware.PermissionLoginToken, middleware.CommonAdminChildRole, wholeHandler.CategoryTrendInfo)
        // #### Whole App
        v1.GET("/whole/app/list",            middleware.PermissionLoginToken, middleware.CommonAdminChildRole, wholeHandler.AppList)
        v1.GET("/whole/app/fetchtrendinfo",  middleware.PermissionLoginToken, middleware.CommonAdminChildRole, wholeHandler.AppTrendInfo)
        // #### Whole Advertise
        ...
        // #### Advertise Content
        v1.GET("/advertise/content/list",            middleware.PermissionLoginToken, middleware.CommonAdminChildRole, advertiseHandler.ContentList)
        v1.GET("/advertise/content/fetchtrendinfo",  middleware.PermissionLoginToken, middleware.CommonAdminChildRole, advertiseHandler.ContentTrendInfo)
        
        // #### Advertise MarketGroup
        v1.GET("/advertise/marketgroup/list",            middleware.PermissionLoginToken, middleware.CommonAdminChildRole, advertiseHandler.MarketGroupList)
        v1.GET("/advertise/marketgroup/fetchtrendinfo",  middleware.PermissionLoginToken, middleware.CommonAdminChildRole, advertiseHandler.MarketGroupTrendInfo)
        ...
        // #### Customer Uuid
        v1.GET("/customer/uuid/list",            middleware.PermissionLoginToken, middleware.CommonAdminChildRole, advertiseHandler.UuidList)
